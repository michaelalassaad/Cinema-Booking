...
const ExperienceReview = ({ navigation }) => {
  ...
  useEffect(async () => {
    if (index == 0) bra = "Byblos";
    else if (index == 1) bra = "Beirut";
    else bra = "Zahle";
    ...
    >
      <SafeAreaView style={styles.container}>
        ...
        <View>
          ...
          <Text style={styles.description}>
            Our cinema company "Movies & Popcorn" was founded in 2021 in Byblos
            Jbeil then expanded quickly due to our success and opened two other
            branches in Beirut and Zahle. Our evergoing success, and the
            increasing number of movie goers is making 'MAP' climb the billboard
            charts and is helping us become one of the most successful cinemas
            in Lebanon.
          </Text>
        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          ...
          >
            ...
            <Button
              ...
              onPress={() => {
                addRev();
                navigation.navigate("Home", { showReview: false });
              }}
            />
          </ScrollView>
        </TouchableWithoutFeedback>
